...
class _HomeScreenContentState extends State<DriverScreenContent> {
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                // Apply filters and trigger the rebuild of the StreamBuilder
                setState(() {
                  // Trigger the rebuild of the StreamBuilder
                });
                Navigator.of(context).pop();
              },
  ...
  double _calculateDistance(DocumentSnapshot document) {
    // Implement your distance calculation logic here
    // For now, returning a constant value for demonstration
    return 10.0;
  }
