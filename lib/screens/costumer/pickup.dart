...
class _PickMultiLocationState extends State<PickUpDelivery> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: isloading?CircularProgressIndicator():Scaffold(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: CustomPaint(
                        ...
                        painter: DashedLinePainter(color: Colors.pink.withOpacity(0.8)),
                      ),
                    ),
                    Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      FaIcon(
                                        ...
                                        color: Colors.pink.withOpacity(0.8).withOpacity(0.8), // Adjust icon color as needed
                                      ),
                                      ...
                                      Icon(Icons.keyboard_arrow_down_outlined, color: Colors.pink.withOpacity(0.8).withOpacity(0.8)),
                                    ],
                                  ),
                                ),
                              ),
  ...
  void _addUser() async {
    ...
    final String company = "From "+_receivedfrom+" to "+_receivedto+" "+companyController.text;
