...
// At this point, workImage will either be set to the default URL or the URL of the first image of type jpeg, png, or jpg.
                  ...
                  return GestureDetector(
                    onTap: () {
                      if(data['status']=="track" && data['toaddress']!="Pick To Location" && data['fromaddress']!=""){
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Navigation(workid: data['id'], destlat: data['tolatitude'], destlong: data['tolongitude'], sourcelat: data['fromlatitude'], sourcelong: data['fromlongitude'], profid: data['assigned'])),
                        );
                      }
                      else if (data['status']!="track" && data['toaddress']!="Pick To Location" && data['fromaddress']!=""){
                        Navigator.push(
                          context,
